In this Hackathon, we created an ensemble of Residual Neural Networks to obtain the best possible evaluation metrics on a given set of detector images from the Large Hadron Collider (LHC).
